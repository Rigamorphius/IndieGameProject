...
/// <summary>
/// UI text displays info about the currently looked at interactive IInteractive
/// The text should be hidden if the player is not currently looking at an interactive object.
/// </summary>
